...
//
//    exchangeRatesCache.putExchangeRates(
//        Map.of(VALID_CURRENCY_EUR, Map.of(VALID_CURRENCY_USD, BigDecimal.valueOf(10)))
//    );
//
...
//    exchangeRatesCache.clearCache();
//    exchangeRatesCache.putExchangeRates(
//        Map.of(VALID_CURRENCY_EUR, Map.of(VALID_CURRENCY_USD, BigDecimal.valueOf(10))));
//
//    assertThrows(NoSuchCurrencyExistsException.class, () -> {
//      exchangeRatesController.getCurrencyExchangeRates(VALID_CURRENCY_USD, VALID_AMOUNT);
//    });
//  }
//
//
